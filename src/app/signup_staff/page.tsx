    ...
    async function onOtpSubmit(otp: string) {
        ...
        try {
            ...
            await setDoc(doc(db, "staff", user.uid), {
                ...commonData,
                // Add other default staff fields if necessary
                address: "",
                idNumber: "",
                staffType: "individual",
                bankAccountNumber: "",
                bankIfscCode: "",
                perEventCharge: 0,
                monthlySalary: 0,
            ...
            <div className="w-full max-w-md">
                <Card className="shadow-2xl">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>
                             {step === 'details' ? 'Interested in joining our team? Fill out your details below.' : 'Enter the OTP sent to your phone.'}
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                         {step === 'details' ? (
                            <Form {...form}>
                                <form onSubmit={form.handleSubmit(onDetailsSubmit)} className="space-y-4">
                                    ...
                                    <Button type="submit" className="w-full" disabled={isSubmitting}>
                                        ...
                                        {isSubmitting ? 'Sending OTP...' : 'Send OTP & Sign Up'}
                                    </Button>
                                </form>
                            </Form>
                         ) : (
